...
public class Pan4 extends JPanel implements Pan {
	 ...
	 * Create the panel.
	 */
	public Pan4(Main win, loginData user) {
		this.user = user;
		...
		checkIdButton.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		birthdayLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		allergyListLabel.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		allergyAddButton.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		allergydelButton.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		memberAddButton.setFont(new Font("HY견고딕", Font.PLAIN, 15));
